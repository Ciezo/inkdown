...
<body>
    ...
    <footer class="mx-auto px-5">
        <ul class="nav justify-content-center border-bottom pb-3 mb-3">
            <li class="nav-item"><a href="license.php" class="nav-link px-2 text-body-secondary">License</a></li>
            <li class="nav-item"><a href="conduct.php" class="nav-link px-2 text-body-secondary">Code of conduct</a></li>
            <li class="nav-item"><a href="terms.php" class="nav-link px-2 text-body-secondary">Terms</a></li>
            <li class="nav-item"><a href="privacy.php" class="nav-link px-2 text-body-secondary">Privacy</a></li>
            <li class="nav-item"><a href="data-collection.php" class="nav-link px-2 text-body-secondary">How we collect data?</a></li>
        </ul>
        <p class="text-center">&copy; 2023 Cloyd Van Secuya </p>
    </footer>
</body>
</html>